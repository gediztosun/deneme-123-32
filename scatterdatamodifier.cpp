...
ScatterDataModifier::
ScatterDataModifier(Q3DScatter* scatter, std::vector<std::vector<double>> &pos) :
  m_graph(scatter), position(pos), m_fontSize(40.0f), m_style(QAbstract3DSeries::MeshSphere), m_smooth(true),
